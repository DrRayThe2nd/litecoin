...
"""Verify that starting pittscoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start pittscoin with -h for help text")
        ...
        self.log.info("Start pittscoin with -version for version information")
