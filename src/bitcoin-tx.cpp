...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s pittscoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  pittscoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded pittscoin transaction") + "\n" +
              "  pittscoin-tx [options] -create [commands]   " + _("Create hex-encoded pittscoin transaction") + "\n" +
              "\n";
